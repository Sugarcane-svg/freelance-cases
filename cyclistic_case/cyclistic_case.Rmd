...
However, the thing is that the director of marketing believes the
company\'s future success depends on maximizing the number of annual
memberships. Consider for a long term goal in general, annual members
are more likely to use the membership benefit, so they may
