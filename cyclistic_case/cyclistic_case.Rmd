...
casual <- c("classic, electric, docked", "only 'Clark St & Elm St' shows less non-member users", "non-members are more than members from Friday to Sunday, and Saturday is a peak")
```
